...
for problem in np.arange(1, 3):
    ...
    # ESN cell
    """esn = etnn.LiESN(
        input_dim=transformer.input_dim,
...
print(transformer.transforms[-1].mean)
print(transformer.transforms[-1].std)
print(transformer.transforms[-1].min)
print(transformer.transforms[-1].max)
